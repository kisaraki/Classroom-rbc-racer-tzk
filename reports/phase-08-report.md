...
- 完成第三關 1800 單位腦／上半身體循環資料、Location、半徑、顏色、氣體交換區及小地圖路徑。
- 完成第四關 900 單位高風險肺循環資料及獨立小地圖路徑 ID。
...
- 第二與第四關 Gas trigger 均落在 270～585 的肺泡微血管；第三關 trigger 均落在 900～1260 的腦／上半身微血管。
...
- [x] 第二關 900 單位肺循環已完成。
- [x] 第三關 1800 單位腦／上半身循環已完成。
- [x] 第四關 900 單位高風險肺循環及倍率已完成。
