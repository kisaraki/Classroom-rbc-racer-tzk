...
import { getEntityType } from "../../js/data/entityTypes.js?v=phase08-routes-r1";
import { LEVELS } from "../../js/data/levels.js?v=phase08-routes-r1";
import { createPlayerState } from "../../js/data/schemas.js?v=phase08-routes-r1";
import {
  EntityManager,
  buildEntityWeightTable,
  sampleEntityOffset
} from "../../js/systems/EntityManager.js?v=phase08-routes-r1";
import {
  assert,
  assertApproximately,
  assertDeepEqual,
