...
import { GameSession } from "../../js/core/GameSession.js?v=phase09-endings-r1";
import { GAME_STATES } from "../../js/core/GameStateMachine.js?v=phase09-endings-r1";
import {
  canCompleteLevel,
  QTE_ACTIONS,
  QTE_EVENTS,
  ...
  QTESystem,
  QTE_TRIGGER_TYPES
} from "../../js/systems/QTESystem.js?v=phase09-endings-r1";
